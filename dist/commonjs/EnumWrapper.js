...
var EnumWrapper = (function () {
    function EnumWrapper(enumObj) {
        ...
        this.keysList = Object.freeze((0, objectKeysUtil_1.getOwnEnumerableNonNumericKeys)(enumObj));
    ...
    EnumWrapper.prototype.isKey = function (key) {
        return (key != null &&
            (0, objectKeysUtil_1.isNonNumericKey)(key) &&
    ...
    EnumWrapper.prototype.asKeyOrThrow = function (key) {
        if (this.isKey(key)) {
            ...
            throw new Error("Unexpected key: ".concat(key, ". Expected one of: ").concat(this.getValues()));
        }
    };
    ...
    EnumWrapper.prototype.asValueOrThrow = function (value) {
        if (this.isValue(value)) {
            ...
            throw new Error("Unexpected value: ".concat(value, ". Expected one of: ").concat(this.getValues()));
        }
    };
