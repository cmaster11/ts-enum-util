 ...
 */
export type WidenEnumType<E extends number | string> = (E extends number ? number : never) | (E extends string ? string : never);
/**
 ...
 */
export type EnumValueVisitorHandler<E extends string | number | null | undefined, R = void> = (value: E) => R;
/**
 ...
 * @template R - The return type of the visitor methods.
 */
export type EnumValueVisitor<E extends string | number, R> = EnumValueVisitorCore<E, R> & {
 ...
 * @template R - The return type of the visitor methods.
 */
export type EnumValueVisitorWithNull<E extends string | number, R> = EnumValueVisitorCore<E, R> & NullEnumValueVisitor<R> & {
 ...
 * @template R - The return type of the visitor methods.
 */
export type EnumValueVisitorWithUndefined<E extends string | number, R> = EnumValueVisitorCore<E, R> & UndefinedEnumValueVisitor<R> & {
 ...
 * @template R - The return type of the visitor methods.
 */
export type EnumValueVisitorWithNullAndUndefined<E extends string | number, R> = EnumValueVisitorCore<E, R> & NullEnumValueVisitor<R> & UndefinedEnumValueVisitor<R> & {
