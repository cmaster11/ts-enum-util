 ...
 * @template T - The type of the value that the enum value is mapped to.
 */
export type EnumValueMapper<E extends string | number, T> = EnumValueMapperCore<E, T> & UnexpectedEnumValueMapper<T>;
/**
 ...
 * @template T - The type of the value that the enum value is mapped to.
 */
export type EnumValueMapperWithNull<E extends string | number, T> = EnumValueMapper<E, T> & NullEnumValueMapper<T> & UnexpectedEnumValueMapper<T>;
/**
 ...
 * @template T - The type of the value that the enum value is mapped to.
 */
export type EnumValueMapperWithUndefined<E extends string | number, T> = EnumValueMapper<E, T> & UndefinedEnumValueMapper<T> & UnexpectedEnumValueMapper<T>;
/**
 ...
 * @template T - The type of the value that the enum value is mapped to.
 */
export type EnumValueMapperWithNullAndUndefined<E extends string | number, T> = EnumValueMapper<E, T> & NullEnumValueMapper<T> & UndefinedEnumValueMapper<T> & UnexpectedEnumValueMapper<T>;
